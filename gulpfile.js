...
var PATHS = {
	scss: {
		watch:	['images/sass/**/*.scss'],
		main:	  ['./images/sass/project.scss'],
		dest:  	'./images/'
	},
	js: {
...
//Run 'gulp --help' to view all arguments
if (yarg.help) { _help(); }
...
if (yarg.lint) { var _lint = true; }

//Run 'gulp --newtab' to open a new tab when gulp first runs
if (yarg.newtab){ var _openNewTab = 'local' }
